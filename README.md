...
```sh
git clone git@github.com:sebsojeda/gatsby-starter-purist.git my-site
...
For more information visit the [Theme repository](https://github.com/sebsojeda/gatsby-theme-purist)
